                    ...
                    html: `
                        ...
                        <div style="display: flex; justify-content: center; align-items: center;">
                            <a href='https://spp.go.senac.br/auth/signin-msc' target="_blank">
                                <button id="btnMicrosoft" style="display: flex; align-items: center; padding: 10px 20px; background-color: #f3f4f6;border: 2px solid #d1d5db;
                                    border-radius: 8px; color: #1f2937; font-weight: bold; font-size: 14px; cursor: pointer; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);
                                        transition: all 0.3s ease;" onmouseover="this.style.backgroundColor='#e5e7eb'; this.style.boxShadow='0px 5px 8px rgba(0, 0, 0, 0.2)';"
