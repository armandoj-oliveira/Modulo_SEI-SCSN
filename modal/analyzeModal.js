function analyzeModal() {
    Swal.fire({
        ...
        html: ` 
            ...
            <br />
            <textarea style="width: 100%; padding: 12px; border: 1px solid #ccc; border-radius: 8px; font-size: 14px; color: #333; background-color: #f9f9f9; 
                resize: vertical; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1); transition: all 0.3s ease;">TESTE</textarea>
            <br />
